...
- Harga pakej, bilik air, privasi satu rumah, self check-in dan maksimum 20 tetamu mengikuti sumber owner. Julat 6–10 orang ialah keterangan kesesuaian rumah; contoh perkongsian harga bukan had pakej.
...
Homepage BM/EN, ringkasan penginapan, FAQ dan halaman polisi menggunakan config bersama. Borang menyediakan anggaran sewaan serta mesej untuk disemak; WhatsApp dibuka dengan butiran itu, dan pengguna sendiri menekan Hantar. Tarikh, harga akhir, bayaran serta booking masih diurus oleh owner—website tidak menyediakan slot real-time atau memproses pembayaran.

Draf pertanyaan disimpan dalam sesi tab sehingga 2 jam sejak simpanan terakhir dan boleh dikosongkan. Penukaran bahasa/reload memulihkan draf yang sah; butiran tetamu tidak dimasukkan ke URL website. Perkongsian homestay hanya menghantar URL homepage awam. Simpanan tema kekal berasingan dalam `localStorage`.

Selepas perubahan kandungan, semak kesetaraan BM/EN dan rujukan sumber. Bahan tambahan yang tiada direkodkan dalam [OWNER-DATA-CHECKLIST.md](OWNER-DATA-CHECKLIST.md), tanpa meminta semula fakta owner yang telah tersedia.
