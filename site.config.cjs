...
module.exports = {
  ...
  facilities: [
    ...
    { icon: 'kitchen', ms: ['Pantry dan ruang makan', 'Pantry dan kemudahan asas disediakan untuk penyediaan makanan ringkas. Makan dan minum di ruang makan.'], en: ['Pantry and dining', 'A pantry and basic facilities are provided for simple food preparation. Use the dining area for meals and drinks.'] },
    { icon: 'car', ms: ['Parking 3 hingga 4 kereta', 'Kawasan rumah biasanya muat 3 hingga 4 kereta. Untuk van atau bas, WhatsApp awal bagi pilihan parking yang sesuai.'], en: ['Parking for 3 to 4 cars', 'The house compound usually fits 3 to 4 cars. For vans or coaches, WhatsApp ahead for suitable parking options.'] },
    { icon: 'home', ms: ['Privasi satu rumah', 'Rumah Semi-D dua tingkat dengan privasi satu rumah, ruang tamu, ruang makan dan kemudahan self check-in.'], en: ['Full-house privacy', 'A two-storey semi-detached house with full-house privacy, a living room, dining area and self check-in.'] }
  ],
  policies: [
  ...
  nearby: [
    ...
    { ms: ['Anggaran 5–10 minit', 'Bandar Jitra dan kemudahan utama', 'Pusat Giat Mara, Dewan Jitra, Masjid Sharifah Fatimah, IKBN Jitra, MRSM Kubang Pasu, Dewan Tunku Anum, Dewan Wawasan, MPKP, IPD Kubang Pasu, Hotel Bustani, Lotus Jitra dan Bandar Jitra.'], en: ['Approx. 5–10 minutes', 'Jitra town and key amenities', 'Pusat Giat Mara, Dewan Jitra, Masjid Sharifah Fatimah, IKBN Jitra, MRSM Kubang Pasu, Dewan Tunku Anum, Dewan Wawasan, MPKP, Kubang Pasu Police HQ, Hotel Bustani, Lotus Jitra and Jitra town.'] },
    { ms: ['Anggaran 10–15 minit', 'Institusi dan kawasan Darulaman', 'Bandar Darulaman, ILP Jitra, POLIMAS, IPG Darulaman, IAB Cawangan Utara, C-Mart BDI, Yawata, Masjid Muttaqin, Hotel Darulaman, Kem Kelubi, Kem Askar Melayu dan SMSAH/Jenan.'], en: ['Approx. 10–15 minutes', 'Institutions and the Darulaman area', 'Bandar Darulaman, ILP Jitra, POLIMAS, IPG Darulaman, Northern Branch IAB, C-Mart BDI, Yawata, Masjid Muttaqin, Hotel Darulaman, Kem Kelubi, Malay Army Camp and SMSAH/Jenan.'] },
    { ms: ['Anggaran 15–20 minit', 'Rekreasi dan penginapan sekitar', 'Masjid Al Muhsinin, Tasik Darulaman, Hotel Regency, Darulaman Golf Club dan Darulaman Fantasia Aquapark.'], en: ['Approx. 15–20 minutes', 'Recreation and nearby hotels', 'Masjid Al Muhsinin, Tasik Darulaman, Hotel Regency, Darulaman Golf Club and Darulaman Fantasia Aquapark.'] },
    { ms: ['Anggaran 20–30 minit', 'Airport dan Alor Setar', 'Masjid As Syabab Kepala Batas, Kolej Tentera Udara, Airport Kepala Batas, Bandar Anak Bukit, Istana Anak Bukit, Masjid Zahir dan Bandar Alor Setar.'], en: ['Approx. 20–30 minutes', 'Airport and Alor Setar', 'Masjid As Syabab Kepala Batas, Air Force College, Kepala Batas Airport, Anak Bukit town, Anak Bukit Palace, Zahir Mosque and Alor Setar town.'] },
    { ms: ['Anggaran 30 minit ke atas', 'Changlun, UUM, Arau dan Bukit Kayu Hitam', 'Pekan Changlun, Matrikulasi Kubang Pasu Changlun, UniMAP, UUM, Kolej Pertanian, MARDI, ABM, EDC-UUM Hotel, SBPI Bukit Kayu Hitam, Bandar Bukit Kayu Hitam, PoliPauh, Matrikulasi Arau dan UiTM Arau.'], en: ['Approx. 30 minutes or more', 'Changlun, UUM, Arau and Bukit Kayu Hitam', 'Changlun town, Kubang Pasu Matriculation College Changlun, UniMAP, UUM, Agriculture College, MARDI, ABM, EDC-UUM Hotel, SBPI Bukit Kayu Hitam, Bukit Kayu Hitam town, PoliPauh, Arau Matriculation College and UiTM Arau.'] }
  ],
  guides: [
    ...
    { slug: 'homestay-konvokesyen-uum-jitra', ms: ['Penginapan untuk konvokesyen UUM', 'Bermalam di Jitra untuk urusan kampus', 'Jitra2Stay menyediakan penginapan untuk keluarga dan rombongan yang datang bagi konvokesyen atau urusan institusi sekitar Kedah Utara.', 'Pakej 2 hingga 5 bilik membolehkan keluarga memilih mengikut jumlah tetamu. Perjalanan ke UUM dan kawasan Changlun dianggarkan 30 minit ke atas dari homestay. Rancang masa tambahan untuk trafik konvokesyen dan semak laluan semasa di Google Maps atau Waze.'], en: ['Accommodation for UUM convocation', 'Stay in Jitra for your campus visit', 'Jitra2Stay provides accommodation for families and groups attending convocation or visiting institutions around northern Kedah.', 'Packages from 2 to 5 rooms let families choose for their guest count. The journey to UUM and the Changlun area is estimated at 30 minutes or more from the homestay. Allow extra time for convocation traffic and check the current route on Google Maps or Waze.'] },
    { slug: 'tempat-menarik-sekitar-jitra', ms: ['Di sekitar Jitra', 'Rancang perjalanan anda', 'Hospital Jitra berada di sebelah kawasan homestay. Bandar Jitra, institusi pendidikan, Tasik Darulaman, Airport Kepala Batas dan destinasi Kedah Utara boleh dirancang dari sini.', 'Anggaran perjalanan: Bandar Jitra 5–10 minit, kawasan Darulaman dan institusi 10–15 minit, Tasik Darulaman dan rekreasi 15–20 minit, Airport Kepala Batas serta Alor Setar 20–30 minit, dan Changlun, UUM, Arau serta Bukit Kayu Hitam 30 minit ke atas. Masa sebenar bergantung pada laluan dan trafik.'], en: ['Around Jitra', 'Plan your visit', 'Jitra Hospital is beside the homestay area. Jitra town, educational institutions, Tasik Darulaman, Kepala Batas Airport and northern Kedah destinations can be reached from here.', 'Estimated journey times: Jitra town at 5–10 minutes, Darulaman and nearby institutions at 10–15 minutes, Tasik Darulaman and recreation at 15–20 minutes, Kepala Batas Airport and Alor Setar at 20–30 minutes, and Changlun, UUM, Arau and Bukit Kayu Hitam at 30 minutes or more. Actual times depend on your route and traffic.'] }
  ]
};
