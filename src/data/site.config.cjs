...
module.exports = {
  business: {
    ...
    securityDeposit: 100, largeGroupSecurityDeposit: 200, earlyLateFee: 20, extraGuestFee: 10,
  ...
  rates: [
    ...
    { rooms: 2, bathrooms: 2, price: 170, exampleGuests: 6 },
  ...
  staySummary: [
    ...
    { key: 'deposit', ms: ['Deposit keselamatan', 'RM{{securityDeposit}} untuk penginapan biasa atau kumpulan kecil; RM{{largeGroupSecurityDeposit}} untuk rombongan besar atau majlis besar seperti kenduri. Owner mengesahkan kategori. Jumlah bayaran awal ialah sewaan + deposit. Deposit dipulangkan selepas pemeriksaan rumah memuaskan; deposit hangus jika berlaku kerosakan atau perkara tidak diingini.'], en: ['Security deposit', 'RM{{securityDeposit}} for regular stays or small groups; RM{{largeGroupSecurityDeposit}} for large groups or major events such as weddings. The owner confirms the category. The initial payment is accommodation + deposit. The deposit is refunded after a satisfactory house inspection and forfeited if damage or unwanted incidents occur.'] },
  ...
  policies: [
    ...
    { key: 'deposit', ms: ['Deposit keselamatan dan jumlah bayaran', 'Deposit keselamatan ialah RM{{securityDeposit}} untuk penginapan biasa atau kumpulan kecil, dan RM{{largeGroupSecurityDeposit}} untuk rombongan besar atau majlis besar seperti kenduri dengan ramai penghuni. Owner mengesahkan kategori deposit semasa tempahan. Jumlah bayaran awal ialah jumlah sewaan ditambah deposit. Selepas check-out, deposit dipulangkan apabila rumah diperiksa dan keadaannya memuaskan. Deposit hangus jika berlaku kerosakan atau perkara tidak diingini.'], en: ['Security deposit and payment total', 'The security deposit is RM{{securityDeposit}} for regular stays or small groups, and RM{{largeGroupSecurityDeposit}} for large groups or major events such as weddings with many occupants. The owner confirms the deposit category when booking. The initial payment is accommodation plus the deposit. After check-out, the deposit is refunded once the house has been inspected and its condition is satisfactory. The deposit is forfeited if damage or unwanted incidents occur.'] },
