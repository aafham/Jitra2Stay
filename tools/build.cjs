...
for(const asset of ['app.js','style.css','gallery.js','gallery.css','navigation.js','navigation.css','share.js','faq.js','faq.css','location.js','location.css','rates.css','planning.css','documents.css','nearby.js','nearby.css','images/favicon.svg']) copy(asset);
